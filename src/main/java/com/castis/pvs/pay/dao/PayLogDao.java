...
public class PayLogDao {
	...
	public Serializable save(PayLog payLog)  throws Exception{
		if(payLog==null) { return null; }
		return  entityManager.unwrap(Session.class).save(payLog);
	}
	
	@SuppressWarnings("unchecked")
	public List<PayLog> selectList(Map<String, Object> paramMap) throws Exception{
		
		if(paramMap==null) {return null;}
		
		Criteria criteria = entityManager.unwrap(Session.class).createCriteria(PayLog.class);
	...
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public void delete(PayLog payLog) throws Exception {
		entityManager.unwrap(Session.class).delete(payLog);
	...
	public int delete(Map<String, Object> paramMap)
		...
		if(paramMap==null || paramMap.isEmpty())
			...
			StringBuffer bf = new StringBuffer();
			bf.append("DELETE FROM tbl_pay_log                       ");
	...
	public void update(PayLog payLog) throws Exception{
		entityManager.unwrap(Session.class).update(payLog);
	}
}
