...
@Repository("payMonthResultDao")
@Transactional(propagation = Propagation.SUPPORTS)
public class PayMonthResultDao {
	@PersistenceContext
	private EntityManager entityManager;


	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public Serializable save(PayMonthResult payMonthResult)  throws Exception{
		
		if(payMonthResult==null) { return null; }
		
		return  entityManager.unwrap(Session.class).save(payMonthResult);
	}
	
	@SuppressWarnings("unchecked")
	public List<PayMonthResult> selectList(Map<String, Object> paramMap) throws Exception{
		
		if(paramMap==null) {return null;}

		Criteria criteria = entityManager.unwrap(Session.class).createCriteria(PayMonthResult.class);
		...
		return (List<PayMonthResult>) list;
		
	}
	
	public PayMonthResult selectOne(Map<String, Object> paramMap) throws Exception{
	...
	public int update(Long idx, Map<String, Object> paramMap) throws Exception {
		...
		if(paramMap==null || paramMap.isEmpty())
			...
			bf.append("update tbl_pay_month_result                       ");
	...
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public void delete(PayMonthResult payMonthResult) throws Exception {
		entityManager.unwrap(Session.class).delete(payMonthResult);
	...
	public int delete(Map<String, Object> paramMap)
		...
		if(paramMap==null || paramMap.isEmpty())
			...
			StringBuffer bf = new StringBuffer();
			bf.append("DELETE FROM tbl_pay_month_result                       ");
	...
	public void update(PayMonthResult payMonthResult) throws Exception{
		entityManager.unwrap(Session.class).update(payMonthResult);
	}
}
