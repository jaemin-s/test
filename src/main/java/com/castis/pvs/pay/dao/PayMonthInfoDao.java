...
@Repository("payMonthInfoDao")
@Transactional(propagation = Propagation.SUPPORTS)
public class PayMonthInfoDao {
	@PersistenceContext
	private EntityManager entityManager;


	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public Serializable save(PayMonthInfo payMonthInfo)  throws Exception{
		
		if(payMonthInfo==null) { return null; }
		
		return  entityManager.unwrap(Session.class).save(payMonthInfo);
	}
	
	@SuppressWarnings("unchecked")
	public List<PayMonthInfo> selectList(Map<String, Object> paramMap) throws Exception{
		
		if(paramMap==null) {return null;}
		
		Criteria criteria = entityManager.unwrap(Session.class).createCriteria(PayMonthInfo.class);
		...
		return (List<PayMonthInfo>) list;
		
	}
	
	public PayMonthInfo selectOne(Map<String, Object> paramMap) throws Exception{
	...
	public int update(Long idx, Map<String, Object> paramMap) throws Exception {
		...
		if(paramMap==null || paramMap.isEmpty())
			...
			bf.append("update tbl_pay_month_info                       ");
	...
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public void delete(PayMonthInfo payMonthInfo) throws Exception {
		
		if(payMonthInfo==null) {return;}

		entityManager.unwrap(Session.class).delete(payMonthInfo);
	}
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public int delete(Map<String, Object> paramMap)
		...
		if(paramMap==null || paramMap.isEmpty())
			...
			StringBuffer bf = new StringBuffer();
			bf.append("DELETE FROM tbl_pay_month_info                       ");
	...
	public void update(PayMonthInfo payMonthInfo) throws Exception{
		entityManager.unwrap(Session.class).update(payMonthInfo);
	}
}
